    ...
    <div class="container col-lg-9 col-sm-12 col-md-10 d-flex flex-lg-row flex-md-row flex-sm-column justify-content-between">
        <div class="d-flex justify-content-between col-lg-8 col-sm-12">
            <a class="navbar-brand" href="?">
                <img src="assets/images/NoteFlix.png" alt="NoteFlix Logo" height="28">
            </a>

            <form class="d-flex" id="searchform">
                <input class="form-control me-2" type="search" id="search" placeholder="Search for someone..." 
                ...
                <div class="bg-white text-end rounded border shadow py-3 px-4 mt-5" 
                    ...
                    <div id="sra" class="text-start">
                        <p class="text-center text-muted">Enter a name or username to begin your search</p>
                    </div>
                </div>
            </form>
        </div>
        ...
        <ul class="navbar-nav flex-fill flex-row justify-content-evenly mb-lg-1 mb-sm-0">
            ...
            <li class="nav-item">
                <a class="nav-link text-dark" data-bs-toggle="modal" data-bs-target="#addnote" href="#"><i class="bi bi-pencil-fill"></i></a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link text-dark" data-bs-toggle="offcanvas" href="#message_sidebar" role="button">
            ...
            <li class="nav-item dropdown dropstart">
                <a class="nav-link" href="#" id="navbarDropdown" role="button"
                    ...
                    <img src="assets/images/profile/<?= $user['profile_pic'] ?>" alt="Profile Picture" height="30" width="30" class="rounded-circle border">
                </a>
                <ul class="dropdown-menu position-absolute top-100 end-50" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item" href="?u=<?= $user['username'] ?>"><i class="bi bi-person"></i> View Profile</a></li>
                    <li><a class="dropdown-item" href="?editprofile"><i class="bi bi-pencil-square"></i> Update Profile</a></li>
                    <li>
                        <hr class="dropdown-divider">
                    </li>
                    <li><a class="dropdown-item" href="assets/php/actions.php?logout"><i class="bi bi-box-arrow-in-left"></i> Sign Out</a></li>
                </ul>
            </li>
        </ul>
    </div>
