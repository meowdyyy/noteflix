<div class="login">
    <div class="col-lg-4 col-md-8 col-sm-12 bg-white border rounded p-4 shadow-sm">
        <form method="post" action="assets/php/actions.php?signup">
            ...
            <h1 class="h5 mb-3 fw-normal">Create a New Account</h1>
            <div class="d-flex">
            ...
            <div class="form-floating mt-1">
                <input type="email" name="email" value="<?=showFormData('email')?>" class="form-control rounded-0" placeholder="Email Address">
            ...
            <div class="mt-3 d-flex justify-content-between align-items-center">
                ...
                <a href="?login" class="text-decoration-none clklink">Already have an account?</a>
            </div>
