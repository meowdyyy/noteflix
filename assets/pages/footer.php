...
<div class="modal fade" id="addnote" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="" style="display:none" id="note_img" class="w-100 rounded border">
                <form method="post" action="assets/php/actions.php?addnote" enctype="multipart/form-data">
                    <div class="my-3">
                        <input class="form-control" name="note_img" type="file" id="select_note_img">
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlTextarea1" class="form-label">Add a Description (Optional)</label>
                        <textarea name="note_text" class="form-control" id="exampleFormControlTextarea1" rows="1"></textarea>
                    </div>
...
foreach($notifications as $not){
    ...
    $note='';
    if($not['note_id']){
        $note='data-bs-toggle="modal" data-bs-target="#noteview'.$not['note_id'].'"';
    }
    $fbtn='';
    ?>
<div class="d-flex justify-content-between border-bottom">
                    <div class="d-flex align-items-center p-2">
                        ...
                        <div>&nbsp;&nbsp;</div>
                        <div class="d-flex flex-column justify-content-center" <?=$note?>>
...
?>
<span class="badge bg-danger">Note Removed</span>
<?php
}
                        ?>
  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-footer">
          ...
          <i class="bi bi-x-octagon-fill"></i> Messaging blocked for this user

</div>

      <div class="input-group p-2 " id="msgsender">
                            <input type="text" class="form-control rounded-0 border-0" id="msginput" placeholder="Type your message..."
