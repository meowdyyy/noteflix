...
--
-- Host: localhost
-- Generation Time: Jan 01, 2025 at 07:07 AM
...
ALTER TABLE `block_list`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_blocklist_user` (`user_id`),
  ADD KEY `fk_blocklist_blocked_user` (`blocked_user_id`);
...
ALTER TABLE `feedbacks`
  ...
  ADD KEY `fk_feedbacks_note` (`note_id`);
...
ALTER TABLE `follow_list`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_followlist_follower` (`follower_id`),
  ADD KEY `fk_followlist_user` (`user_id`);
...
ALTER TABLE `notifications`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_notifications_to_user` (`to_user_id`),
  ADD KEY `fk_notifications_from_user` (`from_user_id`);
...
--
ALTER TABLE `block_list`
  ADD CONSTRAINT `fk_blocklist_blocked_user` FOREIGN KEY (`blocked_user_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `fk_blocklist_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);

--
-- Constraints for table `feedbacks`
--
ALTER TABLE `feedbacks`
  ADD CONSTRAINT `fk_feedbacks_note` FOREIGN KEY (`note_id`) REFERENCES `notes` (`id`),
  ADD CONSTRAINT `fk_feedbacks_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);

--
-- Constraints for table `follow_list`
--
ALTER TABLE `follow_list`
  ADD CONSTRAINT `fk_followlist_follower` FOREIGN KEY (`follower_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `fk_followlist_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);

--
-- Constraints for table `messages`
--
ALTER TABLE `messages`
  ADD CONSTRAINT `fk_messages_from_user` FOREIGN KEY (`from_user_id`) REFERENCES `users` (`id`),
...
--
ALTER TABLE `notifications`
  ADD CONSTRAINT `fk_notifications_from_user` FOREIGN KEY (`from_user_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `fk_notifications_to_user` FOREIGN KEY (`to_user_id`) REFERENCES `users` (`id`);
COMMIT;
